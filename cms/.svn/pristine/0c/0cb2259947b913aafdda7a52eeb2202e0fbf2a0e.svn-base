...
$(document).ready(function() {
	var jshtml = "";
	jshtml+='<link rel="stylesheet" type="text/css" href="../js/library/fullcalendar/css/jquery-ui.min.css"/>';
	jshtml+='<link rel="stylesheet" type="text/css" href="../js/library/fullcalendar/fullcalendar/fullcalendar.css"/>';
	jshtml+=	'<script type="text/javascript" src="../js/library/fullcalendar/fullcalendar/fullcalendar.min.js"></script>';
	$("head").append(jshtml);
});
/**
 * //获取日历    
