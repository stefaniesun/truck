    ...
    if (typeof(data)!="undefined") {
      daysElement.forEach(function (v, i) {
        ...
        if (data[year + '-' + currentmonth + '-' + day]) {
          ...
          //console.log(detail);
    	  html += "<span class='sc-stock'>"+detail.stocks.length+"</span>";
          html += "<span class='sc-price'><dfn>¥</dfn>"+parseInt(detail.min/100)+"-<dfn>¥</dfn>"+parseInt(detail.max/100)+"</span>";
      
          v.querySelector('.lunar-day').innerHTML = html;
          v.querySelector('.day').style.color = "#000000";
          v.style.backgroundColor = "#E5FBFA";
