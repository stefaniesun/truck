...
let urlApi = {
  ...
  updatePersonInfoOper:{   //设置出行人
    ...
    freeUrl:"CustomerWS/updatePersonInfoOper.open",
    isApiKey:true,
    isLoading:true
  },
  getPersonInfo:{   //获取出行人
    url:"SaleVoyageWS/getPersonInfo.cms",
    freeUrl:"CustomerWS/getPersonInfo.open",
    isApiKey:true,
    isLoading:true
  },
  orderPayOper:{   //二次付款
    url:"SaleVoyageWS/orderPayOper.cms",
    freeUrl:"CustomerWS/orderPayOper.open",
    isApiKey:true,
    isLoading:true
  },
  ...
  queryVoyageAndStockList:{   //快捷查询游轮舱型信息
    url:"CustomerWS/queryVoyageAndStockList.open",
    isApiKey:true,
    isLoading:true
  },
  createCruiseOrderBatchOper:{   //查询游轮舱型信息
    url:"SaleVoyageWS/createCruiseOrderBatchOper.cms",
    freeUrl: 'CustomerWS/createCruiseOrderBatchOper.open',
    isApiKey:true,
    isLoading:true
  },
  addCruiseOrderMsgByDistributor: {   //添加消息
    url: "SaleVoyageWS/addCruiseOrderMsgByDistributor.cms",
    freeUrl: 'CustomerWS/addCruiseOrderMsgByDistributor.open',
    isApiKey: true,
    isLoading: true
  },
  getDistributorReadByCruiseOrderOper: {   //查询消息
    url: "SaleVoyageWS/getDistributorReadByCruiseOrderOper.cms",
    freeUrl: 'CustomerWS/getDistributorReadByCruiseOrderOper.open',
    isApiKey: true,
    isLoading: true
  }
};
