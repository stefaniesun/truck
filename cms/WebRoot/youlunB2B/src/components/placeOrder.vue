          ...
          <ul>
            <li v-for="num in content.cabinArr[0].list">
              ...
              <div class="totalPrice pull-right" :class="userType == 'true'? 'tourist':''">
                ...
                <!--<div v-if="userType == 'true'&&num.rebate">后返{{num.rebate}}</div>-->
              </div>
            </li>
          </ul>
        </div>
            ...
            <ul>
              <li v-for="cabin in num.list">
                ...
                <div class="totalPrice pull-right" :class="userType == 'true'? 'tourist':''">
                  ...
                  <!--<div v-if="userType == 'true'&&cabin.rebate">后返{{cabin.rebate}}</div>-->
                </div>
              </li>
            </ul>
          </div>
    ...
    methods:{
      ...
      upData(orderJson){
        ...
        if( sessionStorage.userType === 'false' ){
          parame.openId = sessionStorage.openid;
          parame.outkey = sessionStorage.outkey;
        }
