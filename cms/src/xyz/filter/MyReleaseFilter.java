...
public class MyReleaseFilter implements Filter{
	...
	public void doFilter(
		...
		if(SysPropertyTool.getXmlValue("allowIps")!=null && SysPropertyTool.getXmlValue("allowIps").contains(ip)){
		    chain.doFilter(request1, response1);
		}else if(SysPropertyTool.getValue("allowIps")!=null && SysPropertyTool.getValue("allowIps").contains(ip)){
		    chain.doFilter(request1, response1);
		}else{
